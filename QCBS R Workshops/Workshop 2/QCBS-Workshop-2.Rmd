...
<!-- <img style="float: right; margin: 0px 0px 5px 55px;" src="images/Logos_and_icons/QCBS_logo_notext_2.png"  width="150" /> -->
R Workshop Series
Workshop 2: 
...
<div style="text-align: center"><img src="images/1_Create_an_R_script.png" /></div>


## Create an R script

<div style="text-align: center"><img src="images/2_Create_an_R_script2.Mod_arrow.png" width="800px" /></div>
...
<div style="text-align: center"><img src="images/3_Header.Mod_arrow.png" width="700px" /></div>
...
<div style="text-align: center"><img src="images/4_Section_headings_Mod_arrow 2.png" width="600px" /></div>
...
<img style="float: left; margin: 10px 30px 15px 0px;" src="images/Logos_and_icons/apple_logo.png" width=50px>
...
<div id="right style="width:100%;"">
<img style="float: left; margin: 10px 30px 15px 0px;" src="images/Logos_and_icons/Windows_logo.png" width=50px>
<p style="line-height:15px;">
```{r, eval = FALSE}
...
<div style="text-align: center"><img src="images/5_Importing_data_Mod_arrow.png" width="900px" /></div>
...
<img style="float: right; margin: 0px 0px 5px 55px;" src="images/Table_Reminder_from_Workshop_1_Accessing_data.png"  width="400px" />
...
## Data exploration <img style="float: right; margin: 0px 0px 5px 55px;" src="images/Looking_at_data_Rubik_cube.png"  width="150" />
...
<div style="text-align: center"><img src="images/Excel_csv_good_bad/excel_vs_csv_wrong_good2.png" width="700px" /></div>
...
<div style="text-align: center"><img src="images/Excel_csv_good_bad/excel_vs_excel_wrong_good2.png" width="650px" /></div>
...
<div style="text-align: center"><img src="images/Excel_csv_good_bad/excel_vs_excel_wrong_wrong2.png" width="700px" /></div>
...
<div style="text-align: center"><img src="images/Excel_csv_good_bad/excel_vs_excel_wrong_badDB.png" width="700px" /></div>
...
## Use your data <img style="float: right; margin: 0px 0px 5px 55px;" src="images/Looking_at_data_Rubik_cube.png"  width="150" />
...
##Harder Challenge <img style="float: right; margin: 0px 0px 5px 55px;" src="images/Looking_at_data_Rubik_cube.png"  width="150" />
...
## Fixing CO2_broken <img style="float: right; margin: 0px 0px 5px 55px;" src="images/Looking_at_data_Rubik_cube.png"  width="150" />
...
![](images/read_table_help1.png){width=750px}

![](images/read_table_help2.png){width=750px}
...
![](images/Logos_and_icons/QCBS_logo_notext_2.png){width=250px}
