...
<img style="float: left; margin: -8px 30px 15px 0px;" src="images/Logos_and_icons/apple_logo.png" width=50px>
...
<div id="right style="width:100%;"">
<img style="float: left; margin: 0px 30px 15px 0px;" src="images/Logos_and_icons/Windows_logo.png" width=50px>
<p style="line-height:15px;">
```{r, eval = FALSE}
...
<img style="float: right; margin: 0px 0px 5px 55px;" src="images/Table_Reminder_from_Workshop_1_Accessing_data.png"  width="350px" />
