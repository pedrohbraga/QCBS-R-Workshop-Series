...
![](images/1_Create_an_R_script.png)

## Create an R script

![](images/2_Create_an_R_script2.Mod_arrow.png){width=800px}
...
![](images/3_Header.Mod_arrow.png){width=700px}
...
![](images/4_Section_headings_Mod_arrow 2.png){width=600px}
...
![](images/Logos_and_icons/apple_logo.png){width=50px}
</div>
...
<br id="style="height:10%""/>

<div id="left" style="width:8%;">
![](images/Logos_and_icons/Windows_logo.png){width=50px}
</div>
...
![](images/Looking_at_data_Rubik_cube.png){width=50px}
...
![](images/Excel_csv_good_bad/excel_vs_csv_wrong_good.png){width=250px}
...
![](images/Excel_csv_good_bad/excel_vs_excel_wrong_good.png){width=250px}
...
![](images/Excel_csv_good_bad/excel_vs_excel_wrong_wrong.png){width=250px}
...
![](images/Excel_csv_good_bad/excel_vs_excel_wrong_badDB.png){width=700px}
