...
![](images/schema_slide1.png){width=50%}
...
![](images/graphlm2.2.png){width=100%}
...
###Assumptions
  ...
  * $\widehat{Y}$~i~ : Predicted value
  
  * $\bar{Y}$ : Mean value of all Y~i~
  
  * V~T~ : Total variance
  
  * V~R~ : Variance explained by the regression

  * V~E~ : Residual variance (error)
