...
.center[
![:scale 50%](images/schema_slide1.png)
]
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.38.16.png)
...
![:scale 100%](images/residuals_fitted.png)
...
# verifier cette slide
![:scale 90%](images/std.resid_fitt.png)
...
![:scale 60%](images/Screen Shot 2018-09-22 at 21.39.03.png)
---
...
.pull-right[
![:scale 80%](images/Screen Shot 2018-09-22 at 21.39.15.png)
]
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.39.48.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.08.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.17.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.26.png)
...
```{r}
abund = shapiro.test(bird$MaxAbund)
mass  = shapiro.test(bird$Mass);rbind(abund,mass)
```
...
- Much improved!
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.37.png) -->
...
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.47.png) -->
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.40.54.png) -->
...
![:scale 70%](images/Screen Shot 2018-09-22 at 21.41.05.png)
...
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.41.19.png) -->
...
There exists a difference in mass between the aquatic and terrestrial birds mean of the two groups
...
```{r}
# Unilateral t-test
uni.ttest1 <- t.test(logMass ~ Aquatic, var.equal = TRUE,
                     data = bird, alternative = "less")
uni.ttest1
```
...
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.41.33.png) -->
---
...
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.41.44.png) -->
...
* A **fixed** variable is one that you are specifically interested in (bird mass) whereas a **random** variable is noise that you want to control for (i.e. site a bird was sampled in). See **Linear mixed-effect model (LMM) Workshop 5** next semester for more on this!
...
---
## ANCOVA with one covariate & one factor
...
![:scale 50%](images/Screen Shot 2018-09-22 at 21.42.07.png)
...
![:scale 30%](images/Screen Shot 2018-09-22 at 21.42.22.png)
...
# Learning objectives: Multiple linear regression
...
<!-- ![:scale 40%](images/Screen Shot 2018-09-22 at 21.42.43.png) -->
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.43.15.png)
