...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.38.25.png)
![:scale 40%](images/Screen Shot 2018-09-22 at 21.38.32.png)

```{r eval=FALSE, echo=FALSE, fig.height=4, warning=FALSE}
par(mfrow=c(1,2))
set.seed(1234564)
x = rnorm(100,10,10)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.38.41.png)
![:scale 40%](images/Screen Shot 2018-09-22 at 21.38.54.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.39.03.png)
---
...
- High leverage
- High influence
![:scale 40%](images/Screen Shot 2018-09-22 at 21.39.15.png)
---
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.41.05.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.42.07.png)
...
![:scale 40%](images/Screen Shot 2018-09-22 at 21.42.22.png)
...
library(HH)
vif(clDD ~ clFD + clTmi + clTma + clP + grass, 
    data = Dickcissel)
```
...
We want your [feedback](https://docs.googlgithube.com/spreadsheets/d/1BUZ24UZEMvsF16gxWOm8yAvM_A9DdIeSaOk6b61bzxQ/edit#gid=0)!