...
Here we assume that the databases were all cleaned up and that they are ready to be used for graphing. Our second workshop "Loading and manipulating data" summarise best practices. 

http://qcbs.ca/wiki/r_workshop2
...
---
## Simple example with Iris database
```{r, eval = FALSE}
theme_set(theme_bw())
ggplot(data = iris,             # Data
       aes(x = Sepal.Length,    # Your X-value
...
## Fine Tunning : Title & Axis size, color, face, relabeling ticks
...
Now that you understand the ggplot basics, you can learn more about about design and image manipulation with the "Introduction to graphic design and image manipulation with open source tools": https://qcbs.ca/wiki/graphics \
