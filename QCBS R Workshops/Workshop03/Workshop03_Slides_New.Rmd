...
<img src="images/Layers_ggplot.png" height=50% width=50%>
</div>
...
Multiple packages and functions that help achieve great visualization ("base R", lattice, plotly, rgl, plot3d, maps, etc.). We will focus our workshop on `ggplot2` only. Here is an example: 
...
These layers have specific names that you will see throughout the presentation: 
  ...
  * aesthetics (`aes`): what you want to "see"
  ...
  * labels, legends, themes, zoom, and facets
