...
1. One-way ANOVA
  - One factor with 2 or more levels. If there are 2 levels a **t-test** can be used alternatively
...
.small[.comment[Look at themean of the two groups]]
...
.center[.pull-left2[If your covariate and factor are significant, you will have a scenario that looks like this]]

.pull-right2[If the interaction is significant, outputs will look like these]
...
.comment[Interaction btw logMass and Diet is non-significant]
