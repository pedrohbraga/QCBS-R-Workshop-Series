...
When some portion of code is repeated more than twice in your script, you can write a function. Or if only a part of the code change, you can write a function that includes different arguments.
